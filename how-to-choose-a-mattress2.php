...
div.panel {
    ...
    <body>
      ...
      <div id="full-page-questions">
		...
		<!--Print buttom-->
		<div style="text-align: center; margin: 30px; display: block; padding: 10px; background-color: #006699; color: #fff; width: 160px; margin: 10px auto; border-radius: 50%; box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);">
