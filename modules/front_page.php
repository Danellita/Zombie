<div id="front_page">
    ...
    <div class="front_page1">
        <p>The entire industry works on confusing the consumer. </p>
    </div>
    <div id="confussion">
    ...
    <div class="front_page1">
        ...
        <p><strong>That is why we are here!</strong></p>
        <p>You have full control. You decide what and where to buy and at which price point.</p>
    </div>
    </div>